...
if(($_POST)){
  ...
  fclose($adminfile);
    ...
    fclose($myconfg);
     ...
     $adminconfg = fopen("../admin/application/config/config.php", "w") or die("Unable to open file!");
          ...
          $txt1 .='$config["rewrite_short_tags"] = FALSE;'."\r\n";
          $txt1 .='$config["proxy_ips"] = "";'."\r\n";
         $txt1 .='$config["theme_color"] = "skin-blue";'."\r\n";
 ...
 if($conn){
  ...
  $query=mysql_query("update settings set smtp_username='$smtp_username',smtp_host='$smtp_host',smtp_password='$smtp_password',admin_email='$admin_email' where id='1' ");
