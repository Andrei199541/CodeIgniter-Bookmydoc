<?php 
class ClinicfilterTranslation_model extends CI_Model {	
	...
	function inserthome($data){
		...
		$medicalprofiledata["lang['language']"] = $data["lang['language']"];
		$medicalprofiledata["lang['medicalprofile_lang']"] = $data["lang['medicalprofile_lang']"];unset($data["lang['medicalprofile_lang']"]);
		$doctordata["lang['language']"] = $data["lang['language']"];
		$doctordata["lang['doctor_lang']"] = $data["lang['doctor_lang']"];unset($data["lang['doctor_lang']"]);
		$hospitaldata["lang['language']"] = $data["lang['language']"];
		$hospitaldata["lang['hospital_lang']"] = $data["lang['hospital_lang']"];unset($data["lang['hospital_lang']"]);
		$aboutdata["lang['language']"] = $data["lang['language']"];
		$aboutdata["lang['about_lang']"] = $data["lang['about_lang']"];unset($data["lang['about_lang']"]);
		$termsdata["lang['language']"] = $data["lang['language']"];
		$termsdata["lang['terms_lang']"] = $data["lang['terms_lang']"];unset($data["lang['terms_lang']"]);
		...
		if(isset($updated_id)){
			...
			$doctorfilterfile = fopen($search_lang, "wb") or die("Unable to open file!");				
			$doctorfiltertxt = '<?php ';
			...
			$medicalprofile_lang=$location.$folderName.'/'.'medicalprofile_lang'.$extension;
			$medicalprofile_file = fopen($medicalprofile_lang, "wb") or die("Unable to open file!");				
			$medicalprofile_txt = '<?php ';
			foreach($medicalprofiledata as $key=>$value){
				$medicalprofile_txt .='$'.$key.' = "'.$value.'";'."\r\n";
			}
			$medicalprofile_txt .=' ?>';
			fwrite($medicalprofile_file, $medicalprofile_txt);
			fclose($medicalprofile_file);
			...
			$hospital_lang=$location.$folderName.'/'.'hospital_lang'.$extension;
			$hospital_file = fopen($hospital_lang, "wb") or die("Unable to open file!");				
			$hospital_txt = '<?php ';
			foreach($hospitaldata as $key=>$value){
				$hospital_txt .='$'.$key.' = "'.$value.'";'."\r\n";
			}
			$hospital_txt .=' ?>';
			fwrite($hospital_file, $hospital_txt);
