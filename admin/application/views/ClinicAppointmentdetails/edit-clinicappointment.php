<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active">Edit Clinic Appoinment</li>
      </ol>
   </section>
   <!-- Main content -->
         ...
         <div class="col-md-12">
            ...
            <div class="box">
               <div class="box-header with-border">
                  <h3 class="box-title">Edit Clinic Appoinment </h3>
               </div>
               <!-- /.box-header -->
               <!-- form start -->
                     ...
                     <div class="col-md-6">
						<div class="form-group">
					        ...
					        <select class="form-control select2 js-example-basic-multiple" style="width: 100%;" name="hospital_id" id="hospital_name">
								   <?php
									  foreach($clinicnamedetails as $clidetails){									
								   ?>
									<option value="<?php echo $clidetails->id;?>"<?php if ($clidetails->id == $data->clinic_id)
									echo 'selected';  ?> ><?php echo $clidetails->clinic_name;?></option>	
								   <?php
								   }
								   ?>
                            </select>
						   ...
						   <div class="bootstrap-timepicker">
							<div class="form-group">
							  <label>Clinic Appoinment Time</label>
