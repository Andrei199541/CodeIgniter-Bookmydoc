<div class="content-wrapper">
   ...
   <section class="content-header">
      <h1>
         Add Hospital Package 
      </h1>
      <ol class="breadcrumb">
         <li><a href="#"><i class="fa fa-language" aria-hidden="true"></i>Home</a></li>
         <li><a href="<?php echo base_url();?>Package_ctrl/hospital_package">Package </a></li>
         <li class="active">Add Hospital Package</li>
      </ol>
   </section>
   <!-- Main content -->
         ...
         <div class="col-md-12">
            ...
            <div class="box">
               <div class="box-header with-border">
                  <h3 class="box-title"> Add Hospital Package </h3>
               </div>
               <!-- /.box-header -->
               <!-- form start -->
                  ...
                  <div class="box-body">                 
                     <div class="col-md-12">
					      <div class="form-group has-feedback">
                            ...
                            <input type="text" class="form-control required" data-parsley-trigger="change" data-parsley-minlength="2"  data-parsley-pattern="^[a-zA-Z\  \/]+$" required="" name="package_name"  placeholder="Package_name">
                     ...
                     <tbody>
                        ...
                        <tr>
						   ...
						   <td class="center"><?php echo $pack->package_period; ?></td>
			                  <td class="center">
							  <a class="btn btn-sm btn-primary" href="<?php echo base_url();?>Package_ctrl/edit_hospital_packagedetailsdval/<?php echo $pack->id; ?>">
                              <i class="fa fa-fw fa-edit"></i>Edit</a>
							  
							   <a class="btn btn-sm btn-danger" href="<?php echo base_url();?>Package_ctrl/delete_hospital_package/<?php echo $pack->id; ?>" onClick="return doconfirm()">
