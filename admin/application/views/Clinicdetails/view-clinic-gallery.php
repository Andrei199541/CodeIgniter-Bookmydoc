<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active">View Clinic Gallery</li>
      </ol>
   </section>
   <!-- Main content -->
         ...
         <div class="col-md-12">
            ...
            <div class="box box-warning">
				<div class="box-header with-border ">
					<h2><i class="glyphicon fa fa-bus"></i> <?php echo $data[0]->clinic_name;; ?> Gallery</h2>	
				</div>
				<div class="box-inner">
					<div class="box-content">
						<ul class="thumbnails gallery">
							...
							title="<?php echo $bus->clinic_name; ?>" href="<?php echo $image; ?>"></a>
							</li>
							<?php
							}
							?>
