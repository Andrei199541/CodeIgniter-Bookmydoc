<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active">Add Hospital Appoinment</li>
      </ol>
   </section>
   <!-- Main content -->
         ...
         <div class="col-md-12">
            ...
            <div class="box">
               <div class="box-header with-border">
                  <h3 class="box-title">Add Hospital Appoinment </h3>
               </div>
               <!-- /.box-header -->
               <!-- form start -->
                  ...
                  <div class="box-body">                 
                     <div class="col-md-6">
					   <div class="form-group">
					        ...
					        <select class="form-control" style="width: 100%;" name="hospital_id" id="hospital_name">
							<option value="none"> Select hospital </option>
								   <?php
								     
									  foreach($hospitalnamedetails as $hosdetails){									
								   ?>
							<option value="<?php echo $hosdetails->id;?>" ><?php echo $hosdetails->hospital_name;?></option>	
								   <?php
								   }
								   ?>
                            </select>
