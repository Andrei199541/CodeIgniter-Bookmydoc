<div class="content-wrapper">
   ...
   <section class="content-header">
      <h1>
         Edit Hospital Appoinment 
      </h1>
      <ol class="breadcrumb">
         <li><a href="#"><i class="fa fa-star-o" aria-hidden="true"></i>Home</a></li>
        <li><a href="<?php echo base_url();?>HospitalAppoinment_ctrl/view_appointmentdetails">Hospital Appoinment </a></li>
         <li class="active">Edit Hospital Appoinment</li>
      </ol>
   </section>
   <!-- Main content -->
         ...
         <div class="col-md-12">
            ...
            <div class="box">
               <div class="box-header with-border">
                  <h3 class="box-title">Edit Hospital Appoinment </h3>
               </div>
               <!-- /.box-header -->
               <!-- form start -->
               <form role="form" action="" method="post"  data-parsley-validate="" class="validate" enctype="multipart/form-data">	
                  ...
                  <div class="box-body">                 
					 ...
					 <div class="form-group">
					        ...
					        <select class="form-control select2 js-example-basic-multiple" style="width: 100%;" name="hospital_id" id="hospital_name">
							
								   <?php
								      //$arry_select = explode(",", $data->hospital_id);
									  foreach($hospitalnamedetails as $hosdetails){									
								   ?>
							<option value="<?php echo $hosdetails->id;?>"<?php if ($hosdetails->id == $data->hospital_id)
					         echo 'selected';  ?> ><?php echo $hosdetails->hospital_name;?></option>	
								   <?php
								   }
								   ?>
                            </select>
						   ...
						   <div class="bootstrap-timepicker">
							<div class="form-group">
							  <label>Doctor Appoiinment Time</label>
                  ...
                  <div class="box-footer">
				     ...
				     <div class="col-md-6">
					        ...
					        <select class="form-control select2 js-example-basic-multiple" style="width: 100%;" name="doctor_id" id="doctor_firstname">
								   ...
								   <?php
								      //$arry_select = explode(",", $doctornamedetails->id);
