                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="center">	
							  ...
							  <a class="btn btn-sm btn-primary" href="<?php echo base_url();?>Speciality_ctrl/edit_speciality/<?php echo $visit->id; ?>">
                              <i class="fa fa-fw fa-edit"></i>Edit</a>
							  
							   <a class="btn btn-sm btn-danger" href="<?php echo base_url();?>Speciality_ctrl/delete_speciality/<?php echo $visit->id; ?>" onClick="return doconfirm()">
