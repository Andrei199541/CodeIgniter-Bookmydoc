<div class="content-wrapper">
   ...
   <section class="content-header">
      <h1>
         Add Hospital Appoinment Details
      </h1>
      <ol class="breadcrumb">
         ...
         <div class="col-md-12">
            ...
            <div class="box">
               <div class="box-header with-border">
                  <h3 class="box-title">Add Hospital Appoinment Details</h3>
               </div>
               <!-- /.box-header -->
               <!-- form start -->
                     ...
                     <div class="col-md-6">
					   <div class="form-group">
							...
							<option value="none"> Select hospital </option>
								   ...
								   ?>
							<option value="<?php echo $hosdetails->id;?>"<?php if (in_array($hosdetails->id, $arry_select))
