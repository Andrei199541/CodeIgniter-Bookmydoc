         ...
         <div class="col-md-12">
            ...
            <div class="box">
               <div class="box-header with-border">
                  <h3 class="box-title">Add Medicalcenter Appoinment </h3>
               </div>
               <!-- /.box-header -->
               <!-- form start -->
                     ...
                     <div class="col-md-6">
					  <div class="form-group">
							...
							<option value="none"> Select Medical Center </option>
								   ...
								   ?>
							<option value="<?php echo $mdetails->id;?>" ><?php echo $mdetails->medical_name;?></option>	
								   <?php
								   }
								   ?>
                            </select>
						   ...
						   <div class="bootstrap-timepicker">
							<div class="form-group">
							  <label>Doctor Appoinemt Time</label>
