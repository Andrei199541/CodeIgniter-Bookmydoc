<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active">View Doctor Gallery</li>
      </ol>
   </section>
   <!-- Main content -->
      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <div class="box box-warning">
						    ...
						    <h2><i class="glyphicon fa fa-bus"></i> <?php echo $data[0]->doctor_firstname;; ?> Gallery</h2>	
                            ...
                            <li class="thumbnail" data-id="<?php echo $bus->id; ?>">
                                <a style="background:url(<?php echo base_url().$image; ?>) no-repeat; background-size:120px;"
                                   title="<?php echo $bus->doctor_firstname; ?>" href="<?php echo $image; ?>"></a>
                            </li>
                            <?php
							}
							?>
