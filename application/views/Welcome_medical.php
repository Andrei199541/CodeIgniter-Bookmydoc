									...
									<div class="checkin-homesubhosp">
										...
										<div class="head-my-listing">
											<div class="alert">
												...
												<h4><?php if($lghosmod102){ echo $lghosmod102; }else { ?> You are using 15 days free trial version.Once the trial period is expired , your medical listing will be removed from Search Filter. Select any package to extend your service under Bookmydoc.<?php } ?>
												</h4>
											</div>								 
										</div>
										...
										<div class="head-my-listing">
											<div class="alert">
												<button class="close" data-dismiss="alert" type="button">×</button>
												<h3><?php if($lghosmod101){ echo $lghosmod101; }else { ?>Alert Message<?php } ?>:</h3>
												<h4>  <?php if($lghosmod103){ echo $lghosmod103; }else { ?>Your Package period is expired . Kindly Select any package to list your medical under Bookmydoc.<?php } ?>
												</h4>
											</div>								 
										</div>
										<?php } else{ ?>
													...
													<div class="left-events">
														...
														<div class="pt-ent">
															<div class="row">
																...
																<div class="col-lg-4">
																	<h6><?php echo $mysubhosp->medical_address; ?> <?php echo $mysubhosp->city_name;?>,<?php echo $mysubhosp->state_name;?>,<?php echo $mysubhosp->country_name;?>.<?php echo $mysubhosp->hospital_zip;?></h6>
																</div>
															</div>
														</div>
													</div>
															...
															<div class="form-group hos-frm-grp">
																<div class="col-lg-10">
																	<div class="row">
																		...
																		<div class="col-lg-8">
																			<input type="text" class="form-control"  placeholder="Hospital Name" name="medical_name" data-parsley-pattern="^[a-zA-Z\  \/]+$" data-parsley-minlength="3" data-parsley-maxlength="25"required =" " >
																		</div>
																	</div>
																	<div class="row">
																		<div class="col-lg-3">
																	...
																	<div class="col-lg-7">
																		<div class="prf-add-dct">
																			...
																			<div class="prf-add-dct-1">
																				...
																				<p><?php echo $subhosp->city_name; ?>,<?php echo $subhosp->state_name; ?>,<?php echo $subhosp->country_name; ?>  <?php echo $subhosp->medical_zip; ?>
																				</p>
																			</div>
																		</div>
																	</div>
													...
													<div class="col-lg-10">
														<div class="row">
															...
															<div class="col-lg-8">
																...
																<?php $arry_select = explode(",", $hospital_data->medical_affilliations); foreach($affilliation as $row_affilliation){ ?>
														...
														<div class="row">
															...
															<div class="col-lg-8">
																...
																<?php $arry_select = explode(",", $hospital_data->medical_languages); foreach($tab_languages as $row_languages){ ?>
										...
										<div class="form-hospital-dash outhospitaladd">
											<div class="row  ">
												...
												<form method="post" id="gallery_imagefirst_hospital" enctype="multipart/form-data">
													...
													<input type="hidden" name="medical_id" value="<?php echo $hos_id;?>">
												...
												<form method="post" data-parsley-validate="" enctype="multipart/form-data">
													<div class="col-lg-10">
														...
														<div class="row">
															...
															<div class="col-lg-8">
																<input type="text" class="form-control" value="<?php echo $hospital_data->hospital_name; ?>" name="medical_name" data-parsley-pattern="^[a-zA-Z\  \/]+$" data-parsley-minlength="3" data-parsley-maxlength="25"required =" " placeholder="Name">
															</div>
														</div>
														<div class="row">
															<div class="col-lg-3">
															...
															<div class="col-lg-8">
																<input type="text" class="form-control" value="<?php echo $hospital_data->hospital_established_date; ?>" name="medical_established_date" placeholder="YYYY/MM/DD" required =" ">
															</div>
														</div>
														<div class="row">
															<div class="col-lg-3">
															...
															<div class="col-lg-8">
																<input type="text" value="<?php echo $hospital_data->hospital_zip; ?>" name="medical_zip" class="form-control" placeholder="1234" data-parsley-type="digits" data-parsley-type-message="only numbers" data-parsley-maxlength="7" required =" ">
															</div>
														</div>
														<div class="row">
															<div class="col-lg-3">
															...
															<div class="col-lg-8">
																<input type="text" value="<?php echo $hospital_data->hospital_website; ?>" name="medical_website" class="form-control" placeholder="<?php if($lghosmod72){ echo $lghosmod72; }else { echo "www.example.com"; }?>" required="">
															</div>
														</div>
														<div class="row">
															<div class="col-lg-3">
														...
														<div class="row">
															...
															<div class="col-lg-8">
																<input type="text" value="<?php echo $hospital_data->hospital_address; ?>" name="medical_address" class="form-control" placeholder="Address here" required="">
															</div>
														</div>
														<div class="row">
															<div class="col-lg-3">
															...
															<div class="col-lg-8">
																<input type="text" value="<?php echo $hospital_data->about_hospital; ?>" name="about_medical"class="form-control" placeholder="" required="">
															</div>
														</div>
														<div class="row">
															<div class="col-lg-3">
														...
														<div class="row">
															...
															<div class="col-lg-8">
																<input type="text" value="<?php echo $hospital_data->hospital_awards; ?>" name="medical_awards" class="form-control" placeholder="enter awards" required="">
															</div>
														</div>
														<div class="row">
															<div class="col-lg-3">
															...
															<div class="col-lg-8">
																<input type="text" value="<?php echo $hospital_data->hospital_memberships; ?>" name="medical_memberships" class="form-control" placeholder="enter memberships" required="">
															</div>
														</div>
													</div>
													<div class="clearfix"></div>
