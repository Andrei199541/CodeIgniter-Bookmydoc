                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-3">
                                                                            <div class="text-left-hsp">
                                                                                <h6><?php if($this->lang->line('hospital_tab_B22')){ ?><?php echo $this->lang->line('hospital_tab_B22'); }else{ ?>Clinic Name<?php } ?></h6>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-8">
         <input type="text" class="form-control"  placeholder="Hospital Name" value="<?php echo $singlesub_result->clinic_name; ?>" name="clinic_name" id="clinic_name" data-parsley-pattern="^[a-zA-Z\  \/]+$" data-parsley-minlength="3" data-parsley-maxlength="25"required =" ">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <input type="text" class="form-control"  placeholder="Date" name="clinic_established_date" id="clinic_established_date" value="<?php echo $singlesub_result->clinic_established_date;?>"  required="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-lg-3">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <input type="text" class="form-control"  placeholder="1234" value="<?php echo $singlesub_result->clinic_zip;?>" name="clinic_zip" id="clinic_zip" data-parsley-type="digits" data-parsley-type-message="only numbers" data-parsley-maxlength="7" required =" ">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-lg-3">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <input type="text" class="form-control"  placeholder="www.example.com" name="clinic_website"  id="clinic_website" value="<?php echo $singlesub_result->clinic_website;?>" required="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-lg-3">
															...
															<div class="col-lg-8">
																<select    name="cities_id" class="form-control" id="city_dropdown_docsubcenter"  required="">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <input type="text" class="form-control" value="<?php echo $singlesub_result->clinic_address;?>" placeholder="Address here" id="clinic_address" name="clinic_address" required="">
                                                                        </div>
                                                                    </div>
