...
<input type="hidden" value="clinic" id="tabtakeparser" >
											...
											<div class="col-lg-12">
												<div class="col-lg-8 evt-br">
													...
													<div class="left-events">
														<h5 class="lft-h5"><?php echo $mysubhosp->clinic_name;?></h5>
														...
														<div class="pt-ent">
															<div class="row">
																...
																<div class="col-lg-4">
																	<h6><?php echo $mysubhosp->clinic_address; ?> <?php echo $mysubhosp->city_name;?>,<?php echo $mysubhosp->state_name;?>,<?php echo $mysubhosp->country_name;?>.<?php echo $mysubhosp->hospital_zip;?></h6>
																</div>
															</div>
														</div>
													</div>
															...
															<div class="form-group hos-frm-grp">
																<div class="col-lg-10">
																	<div class="row">
																		...
																		<div class="col-lg-8">
																			<input type="text" class="form-control"  placeholder="Hospital Name" name="clinic_name" data-parsley-pattern="^[a-zA-Z\  \/]+$" data-parsley-minlength="3" data-parsley-maxlength="25"required =" " >
																		</div>
																	</div>
																	<div class="row">
																		<div class="col-lg-3">
																	...
																	<div class="row">
																		...
																		<div class="col-lg-8">
																			<input type="text" class="form-control"  placeholder="YYYY/MM/DD" name="clinic_established_date" required="">
																		</div>
																	</div>
																	<div class="row">
																		<div class="col-lg-3">
																		...
																		<div class="col-lg-8">
																			<input type="text" class="form-control"  placeholder="www.example.com" name="clinic_website" required="">
																		</div>
																	</div>
																	<div class="row">
																		<div class="col-lg-3">
																	...
																	<div class="row">
																		...
																		<div class="col-lg-8">
																			<textarea class="form-control" placeholder="Address here" name="clinic_address" required=""></textarea>
																		</div>
																	</div>
																	<div class="row">
																		<div class="col-lg-3">
																	...
																	<div class="row">
																		...
																		<div class="col-lg-8">
																			<textarea class="form-control" name="about_clinic" required=""></textarea>
																		</div>
																	</div>
																</div>
															</div>
																	...
																	<div class="col-lg-7">
																		<div class="prf-add-dct">
																			...
																			<div class="prf-add-dct-1">
																				<h3><?php echo $subhosp->clinic_name; ?></h3>
																				<h4><?php echo $subhosp->clinic_address; ?></h4>
																				<p><?php echo $subhosp->city_name; ?>,<?php echo $subhosp->state_name; ?>,<?php echo $subhosp->country_name; ?>  <?php echo $subhosp->clinic_zip; ?>
																				</p>
																			</div>
																		</div>
																	</div>
										...
										<div class="form-hospital-dash outhospitaladd">
											<div class="row  ">
												...
												<form method="post" id="gallery_imagefirst_hospital" enctype="multipart/form-data">
													...
													<input type="hidden" name="clinic_id" value="<?php echo $hos_id;?>">
												...
												<form method="post" data-parsley-validate="" enctype="multipart/form-data">
													<div class="col-lg-10">
														...
														<div class="row">
															...
															<div class="col-lg-8">
																<input type="text" class="form-control" value="<?php echo $hospital_data->clinic_name; ?>" name="clinic_name" data-parsley-pattern="^[a-zA-Z\  \/]+$" data-parsley-minlength="3" data-parsley-maxlength="25"required =" " placeholder="Name">
															</div>
														</div>
														<div class="row">
															<div class="col-lg-3">
															...
															<div class="col-lg-8">
																<input type="text" class="form-control" value="<?php echo $hospital_data->clinic_established_date; ?>" name="clinic_established_date" placeholder="YYYY/MM/DD" required =" ">
															</div>
														</div>
														<div class="row">
															<div class="col-lg-3">
															...
															<div class="col-lg-8">
																<input type="text" value="<?php echo $hospital_data->clinic_zip; ?>" name="clinic_zip" class="form-control" placeholder="1234" data-parsley-type="digits" data-parsley-type-message="only numbers" data-parsley-maxlength="7" required =" ">
															</div>
														</div>
														<div class="row">
															<div class="col-lg-3">
															...
															<div class="col-lg-8">
																<input type="text" value="<?php echo $hospital_data->clinic_website; ?>" name="clinic_website" class="form-control" placeholder="<?php if($lghosmod72){ echo $lghosmod72; }else { echo "www.example.com"; }?>" required="">
															</div>
														</div>
														<div class="row">
															<div class="col-lg-3">
														...
														<div class="row">
															...
															<div class="col-lg-8">
																<input type="text" value="<?php echo $hospital_data->clinic_address; ?>" name="clinic_address" class="form-control" placeholder="Address here" required="">
															</div>
														</div>
														<div class="row">
															<div class="col-lg-3">
															...
															<div class="col-lg-8">
																<input type="text" value="<?php echo $hospital_data->about_clinic; ?>" name="about_clinic"class="form-control" placeholder="" required="">
															</div>
														</div>
														<div class="row">
															<div class="col-lg-3">
														...
														<div class="row">
															...
															<div class="col-lg-8">
																<input type="text" value="<?php echo $hospital_data->clinic_awards; ?>" name="clinic_awards" class="form-control" placeholder="enter awards" required="">
															</div>
														</div>
														<div class="row">
															<div class="col-lg-3">
															...
															<div class="col-lg-8">
																<input type="text" value="<?php echo $hospital_data->clinic_memberships; ?>" name="clinic_memberships" class="form-control" placeholder="enter memberships" required="">
															</div>
														</div>
													</div>
													<div class="clearfix"></div>
