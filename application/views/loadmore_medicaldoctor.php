...
?>
        ...
        <div class="view-more loadmore">
		 <div id="moremedicaldoctor<?php echo $doctor_detail->id; ?>" class="moreboxmedicaldoctor">
              <a href="javascript:void(0);" id="<?php  echo $doctor_detail->id; ?>" onclick="call_filtermoremedicaldoctor(<?php echo $last_id; ?>)" class="filterloadmoremedicaldoctor" ><h3><span><img src="<?php echo base_url(); ?>assets/images/patient-login/vmore.png" /> </span><?php if($lgfdviewmore){ echo $lgfdviewmore; }else { ?>View More<?php } ?></h3></a>                                 
        </div>
    </div>
		 <?php } ?>
