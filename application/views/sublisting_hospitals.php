                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-3">
                                                                            <div class="text-left-hsp">
                                                                                <h6><?php if($this->lang->line('hospital_tab_B22')){ ?><?php echo $this->lang->line('hospital_tab_B22'); }else{ ?>Hospital Name<?php } ?></h6>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-8">
         <input type="text" class="form-control"  placeholder="Hospital Name" value="<?php echo $singlesub_result->hospital_name; ?>" name="hospital_name" id="hospital_name" data-parsley-pattern="^[a-zA-Z\  \/]+$" data-parsley-minlength="3" data-parsley-maxlength="25"required =" " >
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <input type="text" class="form-control"  placeholder="Date" name="hospital_established_date" id="hospital_established_date" value="<?php echo $singlesub_result->hospital_established_date;?>"  required="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-lg-3">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <input type="text" class="form-control"  placeholder="1234" value="<?php echo $singlesub_result->hospital_zip;?>" name="hospital_zip" id="hospital_zip" data-parsley-type="digits" data-parsley-type-message="only numbers" data-parsley-maxlength="7" required =" ">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-lg-3">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <input type="text" class="form-control"  placeholder="www.example.com" name="hospital_website"  id="hospital_website" value="<?php echo $singlesub_result->hospital_website;?>" required="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-lg-3">
															...
															<div class="col-lg-8">
																<select    name="cities_id" class="form-control" id="city_dropdown_docsubcenter"  required="">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <input type="text" class="form-control" value="<?php echo $singlesub_result->hospital_address;?>" placeholder="Address here" id="hospital_address" name="hospital_address" required="">
                                                                        </div>
                                                                    </div>
